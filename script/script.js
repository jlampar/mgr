		...
		for(var pth = 0; pth < dataSet.length - 1; pth++) {
			...
			for(var l = lists.colors.length - 1 ; l >= 0 ; l--) {
				...
				liDiv.append("div").text(
					...
					).style("display", "inline-block").style("width", "170px").style("height", "10px").style("text-align", "right").style("margin-right", "1em");
				...
				liDiv.append("div").text(
					...
					).style("display", "inline-block").style("width", "170px").style("height", "10px").style("text-align", "left").style("margin-left", "1em");
			}
